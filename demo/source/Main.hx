...
class Main extends Sprite {
	...
	#if ios
	var initialState:Class<FlxState> = GameCenterPlayState; // The FlxState the game starts with.
	#elseif mac
	var initialState:Class<FlxState> = GameCenterPlayState; // The FlxState the game starts with.
	#else
	var initialState:Class<FlxState> = FallbackPlayState; // The FlxState the game starts with.
	#end
